...
public class GuiRender {
    ...
    public GuiRender(Window window) {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("chapter-02/resources/shaders/gui.vert", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("chapter-02/resources/shaders/gui.frag", GL_FRAGMENT_SHADER));
