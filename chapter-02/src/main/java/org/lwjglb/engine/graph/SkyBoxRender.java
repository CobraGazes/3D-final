...
public class SkyBoxRender {
    ...
    public SkyBoxRender() {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("chapter-02/resources/shaders/skybox.vert", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("chapter-02/resources/shaders/skybox.frag", GL_FRAGMENT_SHADER));
    ...
    public void render(Scene scene) {
        ...
        for (Material material : skyBoxModel.getMaterialList()) {
            ...
            for (Mesh mesh : material.getMeshList()) {
                ...
                uniformsMap.setUniform("modelMatrix", skyBoxEntity.returnMatrix());
